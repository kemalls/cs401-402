...
def compile_model_optimizer(model):
    ...
    sam_model.compile(
        ...
        metrics=[keras.metrics.SparseCategoricalAccuracy(name="accuracy"),
                 keras.metrics.SparseTopKCategoricalAccuracy(3, name="top3-acc"), ]
    )
    return sam_model
...
def load_saved_model(path):
    # Replace the custom_objects with standard Adam
    return keras.models.load_model(path, custom_objects={'MyOptimizer': keras.optimizers.Adam})
